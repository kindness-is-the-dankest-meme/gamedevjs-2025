...
const tiles = (s: number) => {
  ...
  return [
    ...
    [
      "▚",
      `M 0 0 H ${hs} A ${hs} ${hs} 0 0 1 0 ${hs} V 0 Z M ${s} ${s} H ${hs} A ${hs} ${hs} 0 0 1 ${s} ${hs} Z`,
    ],
    [
      "▞",
    ...
    [
      "╲",
      `M 0 0 V ${hs} A ${hs} ${hs} 0 0 1 ${hs} ${s} H ${s} V ${hs} A ${hs} ${hs} 0 0 1 ${hs} 0 Z`,
    ],
    [
      "╱",
      `M ${hs} 0 A ${hs} ${hs} 0 0 1 0 ${hs} V ${s} H ${hs} A ${hs} ${hs} 0 0 1 ${s} ${hs} V 0 Z`,
    ],
